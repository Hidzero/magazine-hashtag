...
function incrementaruantidadeProduto(idProduto) {
...
function decrementaruantidadeProduto(idProduto) {
...
function desenharProdutoNoCarrinho(idProduto) {
    ...
    document.getElementById(`decrementar-produto-${produto.id}`).addEventListener('click',() => decrementaruantidadeProduto(produto.id));
    document.getElementById(`incrementar-produto-${produto.id}`).addEventListener('click',() => incrementaruantidadeProduto(produto.id));
...
export function adicionarAoCarrinho(idProduto) {
    if (idProduto in idsProdutoCarrinhoComQuantidade){
        incrementaruantidadeProduto(idProduto);
        return;
    }
